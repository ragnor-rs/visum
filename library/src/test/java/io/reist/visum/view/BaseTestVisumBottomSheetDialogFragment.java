 ...
 */
public abstract class BaseTestVisumBottomSheetDialogFragment extends VisumBottomSheetDialogFragment<TestPresenter>
    ...
    public BaseTestVisumBottomSheetDialogFragment(int viewId) {
        super(viewId);
    }
